...
function SpeedCurveHead() {
  ...
  return (
    <>
      <Script id="sc-inline" strategy="lazyOnload">
        {`
      ...
      <Script id="sc-js" src="https://cdn.speedcurve.com/js/lux.js?id=4367545624" strategy="lazyOnload"></Script>
    </>
  )
}

export default SpeedCurveHead
